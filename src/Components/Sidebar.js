        ...
        <div></div>
          ...
          <div className='md:block hidden fixed top-[25%] z-10'>
            <div className='flex flex-col'>
              ...
              <a href='#projects' className='rounded-full shadow-lg bg-gray-100 shadow-gray-400 m-2 p-4 hover:scale-110 ease-in cursor-pointer duration-300'>
                <AiOutlineProject size={20}/>
              </a>
              <a href='#main' className='rounded-full shadow-lg bg-gray-100 shadow-gray-400 m-2 p-4 hover:scale-110 ease-in cursor-pointer duration-300'>
                <BsPerson size={20}/>
              </a>
              <a href='#contact' className='rounded-full shadow-lg bg-gray-100 shadow-gray-400 m-2 p-4 hover:scale-110 ease-in cursor-pointer duration-300'>
                <AiOutlineMail size={20}/>
              </a>
            </div>
          </div>
